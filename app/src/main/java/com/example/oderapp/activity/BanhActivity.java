...
import com.example.oderapp.adapter.BanhAdapter;
    ...
    private void loadMore() {
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                adapterBanh.notifyItemInserted(sanPhamMoiList.size()-1);
            }
        });
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                adapterBanh.notifyItemRemoved(sanPhamMoiList.size());
                page = page + 1;
                getData(page);
                        ...
                        sanPhamMoiModel -> {
                            if (sanPhamMoiModel.isSuccess()){
                                if (adapterBanh == null){
                                    ...
                                    adapterBanh = new BanhAdapter(getApplicationContext(), sanPhamMoiList);
                                    ...
                                    adapterBanh.notifyItemRangeInserted(vitri,soluongadd);
                                }
