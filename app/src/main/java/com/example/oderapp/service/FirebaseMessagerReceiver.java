package com.example.oderapp.service;
...
public class FirebaseMessagerReceiver extends FirebaseMessagingService {
    public void onMessagerReceived(@NonNull RemoteMessage message) {
    ...
    private RemoteViews customView(String title, String body) {
        RemoteViews remoteViews = new RemoteViews(getApplicationContext().getPackageName(), R.layout.thong_bao);
