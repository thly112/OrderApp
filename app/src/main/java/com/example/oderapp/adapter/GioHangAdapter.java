...
import com.example.oderapp.Interface.IImageClickListenner;
...
//aa
    ...
    public void onBindViewHolder(@NonNull GioHangAdapter.MyViewHolder holder, int position) {
        ...
        long gia2 = gioHang.getSoluong() * gioHang.getGiasp();
        holder.item_giohang_giasp2.setText(decimalFormat.format(gia2));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ImageView item_giohang_image, imggiam, imgtang;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            imggiam= itemView.findViewById(R.id.item_giohang_tru);
            imgtang= itemView.findViewById(R.id.item_giohang_cong );
            checkBox = itemView.findViewById(R.id.item_giohang_cb);
            //event click
