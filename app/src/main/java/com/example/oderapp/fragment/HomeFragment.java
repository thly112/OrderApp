...
import com.example.oderapp.adapter.PopularAdapter;
...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        PopularAdapter adapter = new PopularAdapter(foodName, popularFoodImages, price); // Lưu ý thứ tự nếu constructor của bạn là (food, image, price)
